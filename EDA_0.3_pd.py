...
#Pull the files
sp_files = glob.glob("sp*[2018,2019,n].csv")
sp_files
my_files = glob.glob("[!sp]*[2018,19].csv")
my_files
...
avg_plt_fig = ax.get_figure().savefig('Average.png')


sp2018df = pd.read_csv('sp_top_2018.csv')
sp2019df = pd.read_csv('sp_top_2019.csv')
my2018df = pd.read_csv('top_2018.csv')
my2019df = pd.read_csv('top_2019.csv')
...
dis_plot_fig = axe.get_figure().savefig('Discrete_plot.png')
